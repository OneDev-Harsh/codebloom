...
const Navbar = () => {
  ...
  return (
    <>
        <nav className="relative z-50 isolate flex items-center justify-between w-full py-4 px-4 md:px-16 lg:px-24 xl:px-32 backdrop-blur border-b text-white border-slate-800">
        <Link
            to="/"
            ...
            <img
                src={assets.logo}
                alt="CodeBloom logo"
                className="h-6 sm:h-7 transition-transform duration-200 group-hover:scale-105"
            />

            <span className="hidden md:inline-flex items-baseline font-semibold text-lg tracking-tight">
                <span className="text-white">Code</span>
                <span className="ml-0.5 bg-gradient-to-r from-[#CB52D4] to-indigo-500 bg-clip-text text-transparent">
                Bloom
                </span>
            </span>
        </Link>
          ...
          <div className="hidden md:flex items-center gap-8 transition duration-500">
            ...
            <Link to="/dev-support">Dev Support</Link>
          </div>
          ...
          <div className="flex items-center gap-1 sm:gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                ...
                <span className="animate-pulse text-indigo-400">{credits}</span>
              </button>
